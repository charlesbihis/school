...
class ProblemManager
{
		...
		switch ( $this->m_obj_user->int_privilege )
		{
			case UP_STUDENT:
				...
				$str_sql_query  = "SELECT P.problem_name, P.problem_id, "
								...
								. "C.Name, Gen.iter_val, P.max_cross "
	...
	function view_problem_details( $int_problem_id )
	{
		...
		switch ( $this->m_obj_user->int_privilege )
		{
			case UP_STUDENT:
				...
				$str_sql_query  = "SELECT P.problem_name, P.problem_id AS ProblemId, UNIX_TIMESTAMP( P.due_date ) as DueDate, P.max_cross as MaxCross, P.number_of_displayed_plants, 
			...
			case UP_TA:
				...
				$str_sql_query = "SELECT P.problem_name, P.problem_desc, U.UserId, U.FirstName, " 
			                   ...
			                   . "FROM XG_ProblemTraitMadeFor P, Course C, User U, XG_Assists A "
			                   . "WHERE A.ta_id = U.UserId "
			                   . "AND U.PrivilegeLvl = " . UP_TA . " "
			                   . "AND U.UserId = '" . $this->m_obj_db->format_sql_string(  $this->m_obj_user->str_username ) . "' "
			...
			case UP_PROFESSOR:
				...
				$str_sql_query = "SELECT P.problem_name, P.problem_desc, U.UserId, U.FirstName, " 
			                   ...
			                   . "P.max_cross, P.number_of_displayed_plants, P.range_of_acceptance, "
			                   . "UNIX_TIMESTAMP(P.start_date) AS start_date, UNIX_TIMESTAMP( P.due_date ) AS due_date "
			                   . "FROM XG_ProblemTraitMadeFor P, Course C, User U, XG_Teaches T "
			                   . "WHERE T.professor_id = U.UserId "
			                   . "AND U.PrivilegeLvl = " . UP_PROFESSOR . " "
			                   . "AND U.UserId = '" . $this->m_obj_db->format_sql_string(  $this->m_obj_user->str_username ) . "' "
			                   . "AND C.CourseId = P.course_id "
	...
	function delete_problem( $int_problem_id ) {
		...
		{			   
			case UP_PROFESSOR:
				...
				$int_number_of_rows = $this->m_obj_db->get_number_of_rows( $this->view_problem_details( $int_problem_id ) );
	...
	function modify_problem( $int_problem_id, $str_problem_name, $str_problem_description, $str_professor_id, $int_course_id, 
