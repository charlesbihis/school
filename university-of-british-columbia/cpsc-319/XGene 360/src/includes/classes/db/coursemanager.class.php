...
class CourseManager
{
	...
	function view_courses()
	{
	  $str_sql_query = null;
		...
		{
/* // student cannot view a list of courses
			case UP_STUDENT:
...
// fix
	...
	// probably can axe this function, if not, save for later
	{
	  $str_sql_query = null;
	  ...
	  $str_sql_query = null;
		...
		{			   
			case UP_PROFESSOR:
				...
				$int_number_of_rows = $this->m_obj_db->get_number_of_rows( $this->view_course_details( $int_course_id ) );
